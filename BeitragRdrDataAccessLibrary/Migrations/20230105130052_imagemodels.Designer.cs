...
namespace BeitragRdrDataAccessLibrary.Migrations
{
    ...
    [Migration("20230105130052_imagemodels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeitragRdr.Models.SubModels.BeitragFace", b =>
                {
                    ...
                    b.Property<int>("ImageModelFacebookId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BeitragRdr.Models.ImageModels.ImageModelFacebook", b =>
                {
                    b.HasBaseType("BeitragRdr.Models.Image");
                    ...
                    b.HasDiscriminator().HasValue("ImageModelFacebook");
                });
            ...
            modelBuilder.Entity("BeitragRdr.Models.ImageModels.ImageModelInstagram", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ImageModelInstagram");
                });

            modelBuilder.Entity("BeitragRdr.Models.ImageModels.ImageModelPinteres", b =>
                {
                    b.HasBaseType("BeitragRdr.Models.Image");
                    ...
                    b.HasDiscriminator().HasValue("ImageModelPinteres");
                });
            ...
            modelBuilder.Entity("BeitragRdr.Models.ImageModels.ImageModelPinteres", b =>
                {
                    b.HasOne("BeitragRdr.Models.SubModels.BeitragPintr", "BeitragPintr")
                        .WithOne("Image")
                        .HasForeignKey("BeitragRdr.Models.ImageModels.ImageModelPinteres", "BeitragPintrId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
