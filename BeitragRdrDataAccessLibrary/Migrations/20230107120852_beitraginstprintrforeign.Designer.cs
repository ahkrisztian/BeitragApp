...
namespace BeitragRdrDataAccessLibrary.Migrations
{
    ...
    [Migration("20230107120852_beitraginstprintrforeign")]
    partial class beitraginstprintrforeign
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeitragRdr.Models.SubModels.BeitragInsta", b =>
                {
                    b.HasOne("BeitragRdr.Models.Beitrag", "Beitrag")
                        ...
                        .HasForeignKey("BeitragRdr.Models.SubModels.BeitragInsta", "BeitragRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BeitragRdr.Models.SubModels.BeitragPintr", b =>
                {
                    b.HasOne("BeitragRdr.Models.Beitrag", "Beitrag")
                        ...
                        .HasForeignKey("BeitragRdr.Models.SubModels.BeitragPintr", "BeitragRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
